...
FOUNDRY_INFO = {
    ...
    "version": "1.3.0",
    "description": "Personal Agentic OS Foundry with FGM (Foundry Goal Mode) overnight loop execution and harness-100 template integration scaffolding.",
    ...
    "core_systems": [
        ...
        },
        {
            ...
            "version": "1.0.0",
            "description": "Scaffolds customized harnesses using harness-100 templates and injects governance controls (ICIP, CRP, TCM, EPR, REE, FGM) automatically."
        }
    ]
}
